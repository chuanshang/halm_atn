 ...
 */
public enum AatnChangeOrderConstantControlFields implements AatnFieldController<ChangeOrderLine, AatnChangeOrderConstantControlFields> {
    /**
     * 资产状态
     */
    ASSET_STATUS_ID("资产状态", "current_asset_status_id", "target_asset_status_id"),
    // /**
    //  * 所属组织
    //  */
    ...
    AatnChangeOrderConstantControlFields(String zhFieldName, String currentFieldName, String targetFieldName) {
    ...
    /**
     * 根据传入规则和目标校验数据，校验枚举中字段的修改是否符合规则
     *
     * @param fieldRules 字段修改规则
     * @param list   数据
     * @return 报错信息
     */
    @Override
        public String validControlFieldsWithRules(Map<String, String> fieldRules, List<ChangeOrderLine> list, MessageSource messageSource, String errorMessage, AatnChangeOrderConstantControlFields fieldEnum) throws IllegalAccessException {
