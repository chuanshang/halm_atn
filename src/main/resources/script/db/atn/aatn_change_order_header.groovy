...
databaseChangeLog(logicalFilePath: 'script/db/aatn_change_order_header.groovy') {
    changeSet(author: "zhisheng.zhang@hand-china.com", id: "2019-04-04-aatn_change_order_header") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'aatn_change_order_header_s', startValue:"1")
        }
        createTable(tableName: "aatn_change_order_header", remarks: "资产信息变更单头") {
            column(name: "change_header_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "change_num", type: "varchar(" + 30 * weight + ")",  remarks: "资产信息变更单编号")  {constraints(nullable:"false")}  
